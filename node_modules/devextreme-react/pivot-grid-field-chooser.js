...
PivotGridFieldChooser.propTypes = {
    ...
    allowSearch: prop_types_1.PropTypes.bool,
    applyChangesMode: prop_types_1.PropTypes.oneOf([
        "instantly",
        "onDemand"
    ]),
    dataSource: prop_types_1.PropTypes.object,
    ...
    layout: prop_types_1.PropTypes.oneOf([
        0,
        1,
        2
    ]),
    ...
    state: prop_types_1.PropTypes.object,
