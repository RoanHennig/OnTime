...
PieChart.propTypes = {
    ...
    segmentsDirection: prop_types_1.PropTypes.oneOf([
        "anticlockwise",
        "clockwise"
    ]),
    ...
    sizeGroup: prop_types_1.PropTypes.string,
    startAngle: prop_types_1.PropTypes.number,
