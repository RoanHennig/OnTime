...
TreeList.propTypes = {
    ...
    allowColumnReordering: prop_types_1.PropTypes.bool,
    allowColumnResizing: prop_types_1.PropTypes.bool,
    autoExpandAll: prop_types_1.PropTypes.bool,
    cacheEnabled: prop_types_1.PropTypes.bool,
    cellHintEnabled: prop_types_1.PropTypes.bool,
    columnAutoWidth: prop_types_1.PropTypes.bool,
    columnChooser: prop_types_1.PropTypes.object,
    columnFixing: prop_types_1.PropTypes.object,
    columnHidingEnabled: prop_types_1.PropTypes.bool,
    columnMinWidth: prop_types_1.PropTypes.number,
    columnResizingMode: prop_types_1.PropTypes.oneOf([
        "nextColumn",
        "widget"
    ]),
    columns: prop_types_1.PropTypes.array,
    columnWidth: prop_types_1.PropTypes.number,
    customizeColumns: prop_types_1.PropTypes.func,
    ...
    dataStructure: prop_types_1.PropTypes.oneOf([
        "plain",
        "tree"
    ]),
    dateSerializationFormat: prop_types_1.PropTypes.string,
    disabled: prop_types_1.PropTypes.bool,
    editing: prop_types_1.PropTypes.object,
    elementAttr: prop_types_1.PropTypes.object,
    errorRowEnabled: prop_types_1.PropTypes.bool,
    expandedRowKeys: prop_types_1.PropTypes.array,
    expandNodesOnFiltering: prop_types_1.PropTypes.bool,
    filterBuilder: prop_types_1.PropTypes.object,
    filterBuilderPopup: prop_types_1.PropTypes.object,
    filterMode: prop_types_1.PropTypes.oneOf([
        "fullBranch",
        "withAncestors"
    ]),
    filterPanel: prop_types_1.PropTypes.object,
    filterRow: prop_types_1.PropTypes.object,
    filterSyncEnabled: prop_types_1.PropTypes.bool,
    filterValue: prop_types_1.PropTypes.oneOfType([
        prop_types_1.PropTypes.array,
        prop_types_1.PropTypes.func,
        prop_types_1.PropTypes.string
    ]),
    focusedColumnIndex: prop_types_1.PropTypes.number,
    focusedRowEnabled: prop_types_1.PropTypes.bool,
    focusedRowIndex: prop_types_1.PropTypes.number,
    focusStateEnabled: prop_types_1.PropTypes.bool,
    hasItemsExpr: prop_types_1.PropTypes.oneOfType([
        prop_types_1.PropTypes.func,
        prop_types_1.PropTypes.string
    ]),
    ...
    highlightChanges: prop_types_1.PropTypes.bool,
    ...
    keyboardNavigation: prop_types_1.PropTypes.object,
    keyExpr: prop_types_1.PropTypes.oneOfType([
        prop_types_1.PropTypes.func,
        prop_types_1.PropTypes.string
    ]),
    loadPanel: prop_types_1.PropTypes.object,
    noDataText: prop_types_1.PropTypes.string,
    onAdaptiveDetailRowPreparing: prop_types_1.PropTypes.func,
    onCellClick: prop_types_1.PropTypes.oneOfType([
        prop_types_1.PropTypes.func,
        prop_types_1.PropTypes.string
    ]),
    onCellDblClick: prop_types_1.PropTypes.func,
    onCellHoverChanged: prop_types_1.PropTypes.func,
    ...
    onDataErrorOccurred: prop_types_1.PropTypes.func,
    onDisposing: prop_types_1.PropTypes.func,
    onEditingStart: prop_types_1.PropTypes.func,
    onEditorPrepared: prop_types_1.PropTypes.func,
    onEditorPreparing: prop_types_1.PropTypes.func,
    onFocusedCellChanged: prop_types_1.PropTypes.func,
    onFocusedCellChanging: prop_types_1.PropTypes.func,
    onFocusedRowChanged: prop_types_1.PropTypes.func,
    onFocusedRowChanging: prop_types_1.PropTypes.func,
    onInitialized: prop_types_1.PropTypes.func,
    onInitNewRow: prop_types_1.PropTypes.func,
    onKeyDown: prop_types_1.PropTypes.func,
    onNodesInitialized: prop_types_1.PropTypes.func,
    onOptionChanged: prop_types_1.PropTypes.func,
    onRowClick: prop_types_1.PropTypes.oneOfType([
        prop_types_1.PropTypes.func,
        prop_types_1.PropTypes.string
    ]),
    onRowCollapsed: prop_types_1.PropTypes.func,
    onRowCollapsing: prop_types_1.PropTypes.func,
    onRowDblClick: prop_types_1.PropTypes.func,
    onRowExpanded: prop_types_1.PropTypes.func,
    onRowExpanding: prop_types_1.PropTypes.func,
    onRowInserted: prop_types_1.PropTypes.func,
    onRowInserting: prop_types_1.PropTypes.func,
    onRowPrepared: prop_types_1.PropTypes.func,
    onRowRemoved: prop_types_1.PropTypes.func,
    onRowRemoving: prop_types_1.PropTypes.func,
    onRowUpdated: prop_types_1.PropTypes.func,
    onRowUpdating: prop_types_1.PropTypes.func,
    onRowValidating: prop_types_1.PropTypes.func,
    onSelectionChanged: prop_types_1.PropTypes.func,
    onToolbarPreparing: prop_types_1.PropTypes.func,
    pager: prop_types_1.PropTypes.object,
    paging: prop_types_1.PropTypes.object,
    parentIdExpr: prop_types_1.PropTypes.oneOfType([
        prop_types_1.PropTypes.func,
        prop_types_1.PropTypes.string
    ]),
    remoteOperations: prop_types_1.PropTypes.object,
    renderAsync: prop_types_1.PropTypes.bool,
    repaintChangesOnly: prop_types_1.PropTypes.bool,
    rowAlternationEnabled: prop_types_1.PropTypes.bool,
    rtlEnabled: prop_types_1.PropTypes.bool,
    scrolling: prop_types_1.PropTypes.object,
    searchPanel: prop_types_1.PropTypes.object,
    selectedRowKeys: prop_types_1.PropTypes.array,
    selection: prop_types_1.PropTypes.object,
    showBorders: prop_types_1.PropTypes.bool,
    showColumnHeaders: prop_types_1.PropTypes.bool,
    showColumnLines: prop_types_1.PropTypes.bool,
    showRowLines: prop_types_1.PropTypes.bool,
    sorting: prop_types_1.PropTypes.object,
    stateStoring: prop_types_1.PropTypes.object,
    tabIndex: prop_types_1.PropTypes.number,
    twoWayBindingEnabled: prop_types_1.PropTypes.bool,
