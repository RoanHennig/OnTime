                ...
                return {
                    ...
                    _cellPrepared: function($cell, options) {
                        ...
                        if ("detail" === options.rowType && "detail" === options.column.command) {
                            $cell.find("." + that.getWidgetContainerClass()).each(function() {
                                var detailGrid = (0, _renderer2.default)(this).parent().data("dxDataGrid");
                                if (detailGrid) {
                                    detailGrid.on("contentReady", function() {
                    ...
                    _handleDetailGridContentReady: function(masterGrid, masterRowIndex, detailGrid) {
                        if (this._isFixedColumns) {
                            var $rows = (0, _renderer2.default)(masterGrid.getRowElement(masterRowIndex));
                            if ($rows && 2 === $rows.length && $rows.eq(0).height() !== $rows.eq(1).height()) {
                                var detailGridWidth = detailGrid.$element().width();
                                masterGrid.updateDimensions().done(function() {
                                    var isDetailHorizontalScrollCanBeShown = detailGrid.option("columnAutoWidth") && true === masterGrid.option("scrolling.useNative"),
                            ...
                            var scrollable = masterGrid.getScrollable();
