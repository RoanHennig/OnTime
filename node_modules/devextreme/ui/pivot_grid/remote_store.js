...
function getRequestsData(options) {
    var columnTotalsOptions, rowExpandedLevel = (0, _uiPivot_grid.getExpandedLevel)(options, "rows"),
        columnExpandedLevel = (0, _uiPivot_grid.getExpandedLevel)(options, "columns"),
