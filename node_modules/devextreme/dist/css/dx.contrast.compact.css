...
.dx-colorview-hue-scale-handle {
  ...
  -webkit-box-shadow: inset -5px 0 0 3px #ffffff, inset 5px 0 0 3px #ffffff, inset -6px 0 1px 4px rgba(255, 255, 255, 0.2), inset 6px 0 1px 4px rgba(255, 255, 255, 0.2);
          box-shadow: inset -5px 0 0 3px #ffffff, inset 5px 0 0 3px #ffffff, inset -6px 0 1px 4px rgba(255, 255, 255, 0.2), inset 6px 0 1px 4px rgba(255, 255, 255, 0.2);
}
.dx-colorview-alpha-channel-handle {
  border: 1px solid rgba(255, 255, 255, 0.2);
  -webkit-box-shadow: inset 0 -5px 0 3px #ffffff, inset 0 5px 0 3px #ffffff, inset 0 -6px 1px 4px rgba(255, 255, 255, 0.2), inset 0 6px 1px 4px rgba(255, 255, 255, 0.2);
          box-shadow: inset 0 -5px 0 3px #ffffff, inset 0 5px 0 3px #ffffff, inset 0 -6px 1px 4px rgba(255, 255, 255, 0.2), inset 0 6px 1px 4px rgba(255, 255, 255, 0.2);
}
...
.dx-button-mode-outlined.dx-button-danger.dx-state-hover {
  background-color: rgba(238, 89, 89, 0.1);
  border-color: #EE5959;
}
...
.dx-button-mode-outlined.dx-button-danger.dx-state-active {
  background-color: rgba(238, 89, 89, 0.3);
  border-color: #EE5959;
  color: #EE5959;
}
...
.dx-button-mode-outlined.dx-button-success.dx-state-hover {
  background-color: rgba(113, 195, 94, 0.1);
  border-color: #71C35E;
}
.dx-button-mode-outlined.dx-button-success.dx-state-focused {
  background-color: rgba(113, 195, 94, 0.2);
  border-color: #71C35E;
}
.dx-button-mode-outlined.dx-button-success.dx-state-active {
  background-color: rgba(113, 195, 94, 0.3);
  border-color: #71C35E;
  color: #71C35E;
}
...
.dx-button-mode-outlined.dx-button-default.dx-state-hover {
  background-color: rgba(82, 187, 231, 0.1);
  border-color: #52BBE7;
}
.dx-button-mode-outlined.dx-button-default.dx-state-focused {
  background-color: rgba(82, 187, 231, 0.2);
  border-color: #52BBE7;
}
.dx-button-mode-outlined.dx-button-default.dx-state-active {
  background-color: rgba(82, 187, 231, 0.3);
  border-color: #52BBE7;
  color: #52BBE7;
}
.dx-button-mode-text {
...
.dx-editor-filled.dx-dropdowneditor.dx-state-active .dx-dropdowneditor-icon {
  background-color: rgba(207, 0, 215, 0.2);
}
...
.dx-editor-filled .dx-dropdowneditor.dx-dropdowneditor-active .dx-dropdowneditor-icon,
.dx-editor-filled .dx-dropdowneditor-button.dx-state-active .dx-dropdowneditor-icon {
  background-color: rgba(207, 0, 215, 0.3);
}
...
.dx-dropdowneditor-active.dx-invalid.dx-dropdowneditor.dx-editor-filled .dx-dropdowneditor-icon {
  background-color: rgba(234, 68, 68, 0.3);
}
...
.dx-dateview-item-selected-frame:before {
  ...
  border-bottom: 1px solid #fff;
  background-repeat: no-repeat;
  background-image: -webkit-gradient(linear, left bottom, left top, from(rgba(0, 0, 0, 0)), color-stop(60%, rgba(0, 0, 0, 0.8)));
...
.dx-calendar-cell.dx-calendar-selected-date.dx-calendar-today.dx-calendar-contoured-date {
  -webkit-box-shadow: inset 0 0 0 1px #fff, inset 0 0 0 1000px #ffffff;
          box-shadow: inset 0 0 0 1px #fff, inset 0 0 0 1000px #ffffff;
}
...
.dx-scheduler-date-time-shader-all-day {
  margin-left: 100px;
  width: 100%;
  background-color: rgba(56, 6, 255, 0.6);
  position: absolute;
  pointer-events: none;
}
...
.dx-scheduler-appointment.dx-state-hover.dx-resizable {
  -webkit-box-shadow: inset 0 5px 0 0 #ffffff, inset 0 -2px 0 0 #ffffff;
          box-shadow: inset 0 5px 0 0 #ffffff, inset 0 -2px 0 0 #ffffff;
}
...
.dx-scheduler-appointment.dx-draggable-dragging {
  -webkit-box-shadow: 7px 7px 15px 0 rgba(50, 50, 50, 0.2), inset 0 -2px 0 0 #ffffff, inset 0 2px 0 0 #ffffff;
          box-shadow: 7px 7px 15px 0 rgba(50, 50, 50, 0.2), inset 0 -2px 0 0 #ffffff, inset 0 2px 0 0 #ffffff;
}
.dx-scheduler-appointment.dx-resizable-resizing,
.dx-scheduler-appointment.dx-draggable-dragging {
  z-index: 1000;
...
.dx-scheduler-all-day-appointment.dx-resizable-resizing {
  -webkit-box-shadow: inset -2px 0 0 0 #ffffff, inset 2px 0 0 0 #ffffff;
          box-shadow: inset -2px 0 0 0 #ffffff, inset 2px 0 0 0 #ffffff;
}
...
.dx-scheduler-all-day-appointment.dx-state-hover.dx-resizable {
  -webkit-box-shadow: inset 5px 0 0 0 #ffffff, inset -2px 0 0 0 #ffffff;
          box-shadow: inset 5px 0 0 0 #ffffff, inset -2px 0 0 0 #ffffff;
}
...
.dx-scheduler-all-day-appointment.dx-draggable-dragging {
  -webkit-box-shadow: inset -2px 0 0 0 #ffffff, inset 2px 0 0 0 #ffffff, 7px 7px 15px 0 rgba(50, 50, 50, 0.2);
          box-shadow: inset -2px 0 0 0 #ffffff, inset 2px 0 0 0 #ffffff, 7px 7px 15px 0 rgba(50, 50, 50, 0.2);
}
...
.dx-htmleditor-content .dx-variable > span {
  background: rgba(207, 0, 215, 0.15);
}
