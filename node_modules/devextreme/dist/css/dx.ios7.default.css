...
@font-face {
  font-family: 'DXIcons';
  src: local("DevExtreme iOS Icons"), local("devextreme_ios_icons"), url(icons/dxiconsios.woff2) format('woff2'), url(icons/dxiconsios.woff) format('woff'), url(icons/dxiconsios.ttf) format('truetype');
  font-weight: normal;
  font-style: normal;
}
.dx-icon {
...
.dx-switch-handle {
  ...
  border-radius: 16px;
  background: #fff;
  -webkit-box-shadow: 0 1px 2px rgba(0, 0, 0, 0.4), 0 4px 5px rgba(0, 0, 0, 0.2);
          box-shadow: 0 1px 2px rgba(0, 0, 0, 0.4), 0 4px 5px rgba(0, 0, 0, 0.2);
  -webkit-transition: margin-left 0.24s ease 0s, left 0.24s ease 0s, width 0.14s ease 0.1s, -webkit-transform 0.14s ease 0.1s;
  transition: margin-left 0.24s ease 0s, left 0.24s ease 0s, width 0.14s ease 0.1s, -webkit-transform 0.14s ease 0.1s;
  transition: margin-left 0.24s ease 0s, left 0.24s ease 0s, width 0.14s ease 0.1s, transform 0.14s ease 0.1s;
  transition: margin-left 0.24s ease 0s, left 0.24s ease 0s, width 0.14s ease 0.1s, transform 0.14s ease 0.1s, -webkit-transform 0.14s ease 0.1s;
}
...
.dx-rtl .dx-switch-handle {
  ...
  right: 50%;
  margin-right: -27px;
  -webkit-transition: margin-right 0.24s ease 0s, right 0.24s ease 0s, width 0.14s ease 0.1s, -webkit-transform 0.14s ease 0.1s;
  transition: margin-right 0.24s ease 0s, right 0.24s ease 0s, width 0.14s ease 0.1s, -webkit-transform 0.14s ease 0.1s;
  transition: margin-right 0.24s ease 0s, right 0.24s ease 0s, width 0.14s ease 0.1s, transform 0.14s ease 0.1s;
  transition: margin-right 0.24s ease 0s, right 0.24s ease 0s, width 0.14s ease 0.1s, transform 0.14s ease 0.1s, -webkit-transform 0.14s ease 0.1s;
}
...
.dx-searchbox .dx-placeholder:before {
  ...
  background-image: url(data:image/png;base64,);
...
.dx-list-item-before-bag .dx-icon-toggle-delete {
  ...
  width: 25px;
  height: 25px;
  background-image: url(data:image/png;base64,);
  background-size: 100%;
}
...
.dx-list-item-ghost-reordering {
  border-bottom: none;
  -webkit-box-shadow: rgba(0, 0, 0, 0.5) 0 0 16px 0;
...
.dx-numberbox-spin.dx-invalid .dx-texteditor-input-container:after {
  right: 4px;
}
.dx-rtl .dx-numberbox-spin.dx-invalid .dx-texteditor-input-container:after,
.dx-rtl.dx-numberbox-spin.dx-invalid .dx-texteditor-input-container:after {
  left: 4px;
  right: auto;
}
...
.dx-dateview-item-selected-frame:before {
  top: -74px;
  background-repeat: no-repeat;
  background-image: -webkit-gradient(linear, left bottom, left top, from(rgba(255, 255, 255, 0)), color-stop(80%, rgba(255, 255, 255, 0.8)));
  background-image: linear-gradient(0deg, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.8) 80%);
}
.dx-dateview-item-selected-frame:after {
  top: 34px;
  background-repeat: no-repeat;
  background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(255, 255, 255, 0)), color-stop(80%, rgba(255, 255, 255, 0.8)));
...
.dx-progressbar-animating-container {
  ...
  background-repeat: no-repeat;
  background-image: -webkit-gradient(linear, right top, left top, color-stop(5%, transparent), color-stop(#74b9ff), color-stop(95%, transparent));
...
.dx-state-disabled .dx-progressbar-animating-container {
  -webkit-animation: none;
          animation: none;
  background-repeat: no-repeat;
  background-image: -webkit-gradient(linear, right top, left top, color-stop(5%, transparent), color-stop(#b7b6bb), color-stop(95%, transparent));
...
.dx-loadindicator-image {
  background-image: url(data:image/gif;base64,);
}
...
.dx-tagbox-single-line .dx-dropdowneditor-input-wrapper {
  border: none;
}
...
.dx-colorbox-input-container.dx-colorbox-color-is-not-defined .dx-colorbox-color-result-preview {
  background: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABEAAAARCAQAAACRZI9xAAAAdElEQVQoU4XR0Q3AIAgFQCarie7UrboJm3QIiyIFFGNe5INcgETAegpQefFCCFPwYZI2qFA/M4EQMQAhKxJgiEcKHFFkwUQY3Q4sBAhUerYzkbaiTUk7Ije0dYoMyeYGi35igUeDzMCiTiKgaPx0BAR1csgHyiFOg0cfv2MAAAAASUVORK5CYII=) no-repeat 0 0;
}
...
.dx-datagrid-content .dx-datagrid-table .dx-row .dx-command-expand.dx-datagrid-group-space {
  vertical-align: middle;
}
...
.dx-treelist-content .dx-treelist-table .dx-row .dx-command-expand.dx-treelist-group-space {
  vertical-align: middle;
}
...
.dx-menu-adaptive-mode.dx-overlay-content {
  ...
  border-radius: 7px;
  -webkit-box-shadow: 0 1px 11px 1px rgba(0, 0, 0, 0.15);
...
.dx-menu-adaptive-mode .dx-treeview-item-content {
  line-height: 32px;
}
...
.dx-rtl .dx-treeview-node .dx-checkbox-container {
  margin-right: 1px;
}
.dx-fieldset {
  margin: 35px 0 15px;
...
.dx-field-value .dx-tagbox-single-line,
.dx-field-value .dx-dropdowneditor-input-wrapper {
  border: none;
  -webkit-box-shadow: none;
          box-shadow: none;
}
...
.dx-timeview-clock {
  background: url(data:image/png;base64,) no-repeat 50% 50%;
}
.dx-timeview-hourarrow {
  background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAqCAQAAAA+XjKzAAAAHklEQVQoU2Ng8GR4BoSeDEDiPxA+YwBTIDjKoCUDAJ6ApYk69jKVAAAAAElFTkSuQmCC);
}
.dx-timeview-minutearrow {
  background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAABBCAQAAABcbc0qAAAAIElEQVQoU2Ng8GR4BoSeDEDiPxA+YwBTIDjKGGUQzQAAYUgBPFDJCN4AAAAASUVORK5CYII=);
}
...
.dx-scheduler-date-table-cell.dx-scheduler-focused-cell {
  -webkit-box-shadow: inset 0 0 0 1px #65bccd;
...
.dx-scheduler-work-space-vertical-grouped .dx-scheduler-time-panel-cell.dx-scheduler-last-group-cell {
  border-bottom: none;
  -webkit-box-shadow: inset 0 -1px 0 rgba(200, 200, 200, 0.6);
...
.dx-scheduler-work-space-vertical-grouped.dx-scheduler-work-space-month .dx-scheduler-group-header {
  -webkit-box-shadow: 0 -2px 0 rgba(200, 200, 200, 0.6);
...
.dx-diagram .dx-diagram-select-b .dx-dropdowneditor-field-template-wrapper .dx-icon,
.dx-diagram .dx-diagram-color-b .dx-dropdowneditor-field-template-wrapper .dx-icon {
  font-size: 18px;
  color: #017aff;
}
