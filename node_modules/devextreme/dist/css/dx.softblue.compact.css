...
.dx-button-mode-outlined.dx-state-focused {
  background-color: rgba(202, 207, 209, 0.2);
  border-color: #cacfd1;
}
.dx-button-mode-outlined.dx-state-active {
  background-color: rgba(202, 207, 209, 0.3);
  border-color: #cacfd1;
  color: #333;
}
...
.dx-button-mode-outlined.dx-button-default.dx-state-hover {
  background-color: rgba(100, 172, 232, 0.1);
  border-color: #64ace8;
}
.dx-button-mode-outlined.dx-button-default.dx-state-focused {
  background-color: rgba(100, 172, 232, 0.2);
  border-color: #64ace8;
}
.dx-button-mode-outlined.dx-button-default.dx-state-active {
  background-color: rgba(100, 172, 232, 0.3);
  border-color: #64ace8;
  color: #64ace8;
}
.dx-button-mode-text {
...
.dx-texteditor.dx-state-readonly.dx-editor-filled.dx-state-hover {
  background-color: rgba(122, 184, 235, 0.07);
}
...
.dx-texteditor.dx-state-hover.dx-editor-filled {
  border-color: transparent;
  background-color: rgba(122, 184, 235, 0.1);
}
...
.dx-editor-filled.dx-dropdowneditor.dx-state-active .dx-dropdowneditor-icon {
  background-color: rgba(122, 184, 235, 0.2);
}
...
.dx-progressbar-animating-container {
  ...
  background-repeat: no-repeat;
  background-image: -webkit-gradient(linear, right top, left top, color-stop(5%, transparent), color-stop(#7ab8eb), color-stop(95%, transparent));
...
.dx-calendar-cell.dx-calendar-selected-date.dx-calendar-today {
  color: #fff;
  -webkit-box-shadow: inset 0 0 0 1000px #7ab8eb;
          box-shadow: inset 0 0 0 1000px #7ab8eb;
  font-weight: normal;
}
.dx-calendar-cell.dx-calendar-selected-date.dx-calendar-contoured-date,
.dx-calendar-cell.dx-calendar-selected-date.dx-calendar-today.dx-calendar-contoured-date {
  -webkit-box-shadow: inset 0 0 0 1px #c7cccf, inset 0 0 0 1000px #7ab8eb;
          box-shadow: inset 0 0 0 1px #c7cccf, inset 0 0 0 1000px #7ab8eb;
}
...
.dx-scheduler-work-space-vertical-grouped .dx-scheduler-time-panel-cell.dx-scheduler-last-group-cell {
  border-bottom: none;
  -webkit-box-shadow: inset 0 -1px 0 rgba(232, 234, 235, 0.6);
          box-shadow: inset 0 -1px 0 rgba(232, 234, 235, 0.6);
}
...
.dx-scheduler-work-space-vertical-grouped.dx-scheduler-work-space-month .dx-scheduler-group-header {
  -webkit-box-shadow: 0 -2px 0 rgba(232, 234, 235, 0.6);
          box-shadow: 0 -2px 0 rgba(232, 234, 235, 0.6);
  border-bottom: none;
}
