...
.dx-theme-marker {
  font-family: "dx.material.purple.light.compact";
}
...
.dx-switch-on-value.dx-state-focused .dx-switch-handle:before {
  -webkit-box-shadow: 0 0 0 10px rgba(156, 39, 176, 0.1);
          box-shadow: 0 0 0 10px rgba(156, 39, 176, 0.1);
  border-radius: 50%;
}
...
.dx-texteditor.dx-editor-outlined.dx-state-focused {
  -webkit-box-shadow: inset 0 0 0 2px #9C27B0;
...
.dx-progressbar-animating-container {
  ...
  background-repeat: no-repeat;
  background-image: -webkit-gradient(linear, right top, left top, color-stop(5%, transparent), color-stop(#9C27B0), color-stop(95%, transparent));
  background-image: linear-gradient(-90deg, transparent 5%, #9C27B0, transparent 95%);
...
.dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused):hover > tr > td.dx-datagrid-group-space {
  border-right-color: rgba(156, 39, 176, 0.04);
}
...
.dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused):hover:not(.dx-row-lines) > td {
  border-bottom: 1px solid rgba(156, 39, 176, 0.04);
  border-top: 1px solid rgba(156, 39, 176, 0.04);
}
...
.dx-rtl .dx-datagrid-rowsview .dx-selection.dx-row:hover > tr > td:not(.dx-focused).dx-datagrid-group-space {
  border-left-color: rgba(156, 39, 176, 0.04);
}
