...
.dx-colorview-palette-handle {
  background: radial-gradient(transparent 5px, rgba(255, 255, 255, 0.2) 6px, #2a2a2a 7px, #2a2a2a 12px, rgba(255, 255, 255, 0.2) 13px);
  -webkit-box-shadow: 0 1px 1px 0 rgba(255, 255, 255, 0.2);
          box-shadow: 0 1px 1px 0 rgba(255, 255, 255, 0.2);
}
.dx-colorview-hue-scale-handle {
  border: 1px solid rgba(255, 255, 255, 0.2);
  -webkit-box-shadow: inset -5px 0 0 3px #2a2a2a, inset 5px 0 0 3px #2a2a2a, inset -6px 0 1px 4px rgba(255, 255, 255, 0.2), inset 6px 0 1px 4px rgba(255, 255, 255, 0.2);
          box-shadow: inset -5px 0 0 3px #2a2a2a, inset 5px 0 0 3px #2a2a2a, inset -6px 0 1px 4px rgba(255, 255, 255, 0.2), inset 6px 0 1px 4px rgba(255, 255, 255, 0.2);
}
.dx-colorview-alpha-channel-handle {
  border: 1px solid rgba(255, 255, 255, 0.2);
  -webkit-box-shadow: inset 0 -5px 0 3px #2a2a2a, inset 0 5px 0 3px #2a2a2a, inset 0 -6px 1px 4px rgba(255, 255, 255, 0.2), inset 0 6px 1px 4px rgba(255, 255, 255, 0.2);
          box-shadow: inset 0 -5px 0 3px #2a2a2a, inset 0 5px 0 3px #2a2a2a, inset 0 -6px 1px 4px rgba(255, 255, 255, 0.2), inset 0 6px 1px 4px rgba(255, 255, 255, 0.2);
}
...
.dx-button-mode-outlined.dx-button-default.dx-state-active {
  background-color: rgba(25, 151, 198, 0.3);
  border-color: #1997c6;
  color: #1997c6;
}
.dx-button-mode-text {
...
.dx-scrollable-customizable-scrollbars .dx-scrollable-container {
  -ms-scrollbar-base-color: #b4b4b4;
  -ms-scrollbar-arrow-color: #b4b4b4;
  -ms-scrollbar-shadow-color: #2a2a2a;
  -ms-scrollbar-track-color: #2a2a2a;
}
...
.dx-tab.dx-state-focused:after {
  ...
  right: -1px;
  left: -1px;
  border-right: 1px solid #1ca8dd;
  border-left: 1px solid #1ca8dd;
...
.dx-rtl .dx-nav-item.dx-state-focused {
  -webkit-box-shadow: inset 0 0 0 1px #1ca8dd;
...
.dx-texteditor.dx-state-readonly.dx-editor-filled.dx-state-hover {
  background-color: rgba(28, 168, 221, 0.07);
}
...
.dx-texteditor.dx-state-hover {
  border-color: rgba(28, 168, 221, 0.4);
}
...
.dx-list-item.dx-list-item-ghost-reordering.dx-state-focused.dx-state-hover {
  color: #7c7c7c;
  background: #2a2a2a;
  border-top: 1px solid rgba(28, 168, 221, 0.5);
  border-bottom: 1px solid rgba(28, 168, 221, 0.5);
  -webkit-box-shadow: 0 0 1px rgba(255, 255, 255, 0.1), 0 1px 3px rgba(255, 255, 255, 0.2);
          box-shadow: 0 0 1px rgba(255, 255, 255, 0.1), 0 1px 3px rgba(255, 255, 255, 0.2);
}
.dx-list-item,
...
.dx-dateview-item-selected-frame:before {
  ...
  border-bottom: 1px solid #4d4d4d;
  background-repeat: no-repeat;
  background-image: -webkit-gradient(linear, left bottom, left top, from(rgba(42, 42, 42, 0)), color-stop(60%, rgba(42, 42, 42, 0.8)));
  background-image: linear-gradient(0deg, rgba(42, 42, 42, 0) 0%, rgba(42, 42, 42, 0.8) 60%);
}
.dx-dateview-item-selected-frame:after {
  top: 34px;
  border-top: 1px solid #4d4d4d;
  background-repeat: no-repeat;
  background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(42, 42, 42, 0)), color-stop(60%, rgba(42, 42, 42, 0.8)));
  background-image: linear-gradient(180deg, rgba(42, 42, 42, 0) 0%, rgba(42, 42, 42, 0.8) 60%);
}
...
.dx-progressbar-animating-container {
  ...
  background-repeat: no-repeat;
  background-image: -webkit-gradient(linear, right top, left top, color-stop(5%, transparent), color-stop(#1ca8dd), color-stop(95%, transparent));
  background-image: linear-gradient(-90deg, transparent 5%, #1ca8dd, transparent 95%);
  background-repeat: repeat;
}
.dx-state-disabled .dx-progressbar-range {
  background-color: rgba(28, 168, 221, 0.6);
}
...
.dx-gallery .dx-gallery-nav-button-next.dx-state-hover:after {
  background-color: rgba(28, 168, 221, 0.5);
}
...
.dx-calendar-cell.dx-state-hover {
  -webkit-box-shadow: inset 0 -1px 0 1000px #343434;
          box-shadow: inset 0 -1px 0 1000px #343434;
  color: #dedede;
}
...
.dx-calendar-cell.dx-state-active:not(.dx-calendar-empty-cell):not(.dx-calendar-selected-date) {
  -webkit-box-shadow: inset 0 -1px 0 1000px rgba(201, 201, 201, 0.2);
          box-shadow: inset 0 -1px 0 1000px rgba(201, 201, 201, 0.2);
}
...
.dx-calendar-cell.dx-calendar-selected-date.dx-calendar-today {
  color: #2a2a2a;
  -webkit-box-shadow: inset 0 0 0 1000px #1ca8dd;
          box-shadow: inset 0 0 0 1000px #1ca8dd;
  font-weight: normal;
}
.dx-calendar-cell.dx-calendar-selected-date.dx-calendar-contoured-date,
.dx-calendar-cell.dx-calendar-selected-date.dx-calendar-today.dx-calendar-contoured-date {
  -webkit-box-shadow: inset 0 0 0 1px #6c6c6c, inset 0 0 0 1000px #1ca8dd;
          box-shadow: inset 0 0 0 1px #6c6c6c, inset 0 0 0 1000px #1ca8dd;
}
...
.dx-tabpanel.dx-state-focused .dx-tabs-scrollable .dx-tab:not(.dx-tab-selected):before {
  ...
  z-index: 2;
  height: 0;
  border-bottom: 1.5px solid #1ca8dd;
  bottom: -1.4px;
}
...
.dx-scheduler-timeline .dx-scheduler-header-panel-cell.dx-scheduler-header-panel-current-time-cell {
  border-bottom: 2px solid #5bc3ea;
  -webkit-box-shadow: none;
          box-shadow: none;
}
...
.dx-scheduler-work-space-month.dx-scheduler-work-space-count .dx-scheduler-date-table-first-of-month {
  color: #1ca8dd;
  background-color: rgba(28, 168, 221, 0.15);
  font-weight: bold;
}
...
.dx-scheduler-work-space-vertical-grouped .dx-scheduler-time-panel-cell.dx-scheduler-last-group-cell {
  border-bottom: none;
  -webkit-box-shadow: inset 0 -1px 0 rgba(77, 77, 77, 0.6);
          box-shadow: inset 0 -1px 0 rgba(77, 77, 77, 0.6);
}
...
.dx-scheduler-work-space-vertical-grouped.dx-scheduler-work-space-month .dx-scheduler-group-header {
  -webkit-box-shadow: 0 -2px 0 rgba(77, 77, 77, 0.6);
          box-shadow: 0 -2px 0 rgba(77, 77, 77, 0.6);
  border-bottom: none;
}
...
.dx-htmleditor-content .dx-variable > span {
  background: rgba(28, 168, 221, 0.15);
}
